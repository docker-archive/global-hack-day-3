...
describe('/applications/{application-name}', function() {
  describe('get', function() {
    it('should respond with 200 ', function(done) {
      ...
      /*eslint-enable*/
      api.get('/applications/{application-name PARAM GOES HERE}')
      .query({
startsWith: 'DATA GOES HERE',tags: 'DATA GOES HERE'
      })
...
startsWith: 'DATA GOES HERE',tags: 'DATA GOES HERE'
  ...
  describe('post', function() {
    it('should respond with 200 An AppDefResponse object.', function(done) {
      /*eslint-disable*/
      var schema = {
        "description": "An Application Object including previously system generated UUID and ephemeralPort.",
        "type": "object",
      ...
      /*eslint-enable*/
      api.post('/applications/{application-name PARAM GOES HERE}')
      .set('Accept', 'application/json')
      .send({
        appdef: 'DATA GOES HERE'
      })
      .expect(200)
      .end(function(err, res) {
        if (err) return done(err);
